    ...
    def one_scene(self, idx : int):
        ...
        while sample['next'] != '':
            ...
            for _ in range(300):
                ...
                print(sample_token, lidar_token)
...
if __name__ == "__main__":
    ...
    #dataset = NuscenesConverter(output_dir="../../data/nuscenes/preprocess/", nusc_dir="../../data/nuscenes")
    dataset = NuscenesConverter(output_dir="/home/pokorsi1/data/nuscenes/preprocess_mini", nusc_dir="/home/pokorsi1/data/nuscenes")
