...
#SBATCH --gres=gpu:1
#SBATCH --output=log_waymo.out        # file name for stdout/stderr
...
#SBATCH --job-name=SLIMw   # job name (default is the name of this file)
...
python -u train.py --dataset waymo --accelerator gpu --data_path /home/pokorsi1/data/waymo_flow/preprocess